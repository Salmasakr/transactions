...
export default function Graph(props) {
  ...
  const filteredTransactions = props.parentData.transactions.filter(
    (transaction) => transaction.customer_id === selectedData
  );


  const selectedCustomer = props.parentData.customers.find(
    ...
    <>
      <form className="max-w-sm mx-auto">
        ...
        >
          ...
          {props.parentData.customers.map((customer) => (
